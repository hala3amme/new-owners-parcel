...
} elseif ($_instance->childHasBeenRendered('l4275153258-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l4275153258-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4275153258-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4275153258-0');
} else {
    $response = \Livewire\Livewire::mount('header.vendor-selector');
    $html = $response->html();
    $_instance->logRenderedChild('l4275153258-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        <?php endif; ?>
                        ...
                        <button class="flex items-center align-middle focus:outline-none" @click="toggleProfileMenu"
                            ...
                            <img class="object-cover w-8 h-8 ml-2 <?php echo e(isRTL() ? 'ml-2' : 'mr-2'); ?> rounded-full"
                                src="<?php echo e(Auth::user()->photo); ?>" alt="" aria-hidden="true" />
...
<?php /**PATH /Users/ambrosetemidayobako/Desktop/Dev/web/glover/resources/views/livewire/header/profile.blade.php ENDPATH**/ ?>