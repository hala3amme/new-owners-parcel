...
<aside class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-primary-500 dark:bg-gray-800 md:hidden"
    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        <a class="flex items-center text-lg font-bold text-gray-100 ltr:ml-6 rtl:mr-6" href="<?php echo e(route('dashboard')); ?>">
            <img src="<?php echo e(appLogo()); ?>" class="w-16 h-16" />
...
<?php /**PATH /Users/ambrosetemidayobako/Desktop/Dev/web/glover/resources/views/layouts/partials/nav/mobile.blade.php ENDPATH**/ ?>